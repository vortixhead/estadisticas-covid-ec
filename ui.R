        ...
        sidebarPanel(
          ...
          conditionalPanel(
            ...
            checkboxGroupInput(
              ...
              label = h4("Filtrar"), 
              choices = list(
                "(MSP) Hospitalización Porcentaje Ocupadas" = "(MSP) Hospitalización Porcentaje Ocupadas", 
                "(MSP) Hospitalización Lista Espera" = "(MSP) Hospitalización Lista Espera", 
                "(MSP) Hospitalización Camas Asignadas" = "(MSP) Hospitalización Camas Asignadas",
                "(MSP) Hospitalización Camas Ocupadas" = "(MSP) Hospitalización Camas Ocupadas",
                ...
                "(RPIS) Hospitalización Lista Espera" = "(RPIS) Hospitalización Lista Espera",
                "(RPIS) Hospitalización Camas Asignadas" = "(RPIS) Hospitalización Camas Asignadas",
                "(RPIS) Hospitalización Camas Ocupadas" = "(RPIS) Hospitalización Camas Ocupadas",
                ...
                "(RPC) Hospitalización Porcentaje Ocupadas" = "(RPC) Hospitalización Porcentaje Ocupadas",
                "(RPC) Hospitalización Lista Espera" = "(RPC) Hospitalización Lista Espera",
                "(RPC) Hospitalización Camas Asignadas" = "(RPC) Hospitalización Camas Asignadas",
                "(RPC) Hospitalización Camas Ocupadas" = "(RPC) Hospitalización Camas Ocupadas",
